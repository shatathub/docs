...
const config: Config = {
  title: 'Shatat Execution APIs',
  tagline: 'A JSON-RPC specification for Shatat execution clients',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://shatathub.github.io',
  ...
  organizationName: 'shatathub', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/shatathub/docs',
          label: 'GitHub',
          position: 'right',
        },
      ],
